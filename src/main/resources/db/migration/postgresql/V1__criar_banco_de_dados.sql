...
CREATE TABLE tbl_colaborador (
    ...
    id_cargo                      INTEGER,
    salario_colaborador           NUMERIC(10,2),
    possui_deficiencia            SMALLINT,
...
CREATE TABLE tbl_indicadores_departamento (
    ...
    percentual_mulheres      NUMERIC(5,2),
    percentual_negros        NUMERIC(5,2),
    percentual_pcds          NUMERIC(5,2),
    percentual_lgbtqia       NUMERIC(5,2),
...
CREATE TABLE tbl_programa_treinamento (
    id_programa_treinamento INTEGER PRIMARY KEY,
...
CREATE TABLE tbl_treinamento_colaborador (
    ...
    id_programa_treinamento  INTEGER,
